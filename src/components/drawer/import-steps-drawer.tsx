  ...
  return (
    <>
      <Drawer
              ...
              <Row justify="end" gutter={32}>
                ...
                <Col xs={4} xxl={2}>
                  <Button
                    ...
                    type="primary"
                    disabled={
                      state.step === 2 && (!state.mappingSaved || state.mappingHasWarning)
        ...
        contentWrapperStyle={{
          boxShadow: 'none',
          height: 'calc(91vh - 68px',
          transform: 'translateY(0px)',
          position: 'fixed',
          top: deviceSize > 1500 ? '150px' : '128px',
        }}
