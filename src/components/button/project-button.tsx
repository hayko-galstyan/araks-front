...
const ButtonContent = ({ project, fullWidth, isGroupProject, isHasPermissionEditing = true }: ProjectButtonContent) => {
...
const StyledButton = styled(({ fullWidth, ...props }) => <Component {...props} />)`
  &.ant-btn-default {
    ...
    &:active {
      ...
      background-color: rgba(35, 47, 106, 0.1) !important;
...
export const ProjectButton = ({
  ...
  return (
    <StyledButton {...props} onDoubleClick={onOpenProject} fullWidth={fullWidth}>
      <ButtonContent
        isHasPermissionEditing={isHasPermissionEditing}
        isGroupProject={isGroupProject}
        project={project}
        fullWidth={fullWidth}
      />
