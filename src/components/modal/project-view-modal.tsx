...
import dotImage from 'components/icons/dots.svg';
              ...
              <Col span={12}>
                {isFetching ? (
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (project.id) {
                        let path = isPublicPage
                          ? `${PATHS.PUBLIC_PREFIX}${PATHS.DATA_SHEET.replace(':id', project.id)}`
                          : PATHS.DATA_SHEET.replace(':id', project.id);
