...
export type InitPreviewGraph = (
  isTemplateEditPage: boolean,
  container: HTMLDivElement,
  params: PickSchemaContextType
) => Graph;
export type InitTamplateListPreviewGraph = (
  isTemplateEditPage: boolean,
  container: HTMLDivElement,
) => Graph;
...
export type InitTemplateListNodes = (graph: Graph, cells: Cell<Cell.Properties>[]) => void;
...
export type InitTemplateEvents = (graph: Graph) => void;
...
export type SchemaReducerState = {
  ...
  view_template: IIsOpen;
  template_preview_data: ITemplatePreview;
};

export type SchemaReducerSetState = {
  setGraph: (graph: Graph) => void;
  setGraphPreview: (graph: Graph) => void;
  ...
  startTemplateView: VoidFunction;
  ...
  finishTemplateView: VoidFunction;
  setTemplatePreviewData: (data: ITemplatePreview) => void;
};
